...
<div class="w-1/5 h-full sm:w-3/5 md:w-1/12 md:ml-3  xl:w-2/5">
  ...
  <ul class="hidden w-1/2 h-12  pt-2 flex  justify-evenly self-center flex-wrap sm:hidden lg:hidden xl:flex xl:block xl:w-full">
    ...
    <li class="flex" @click.prevent="toTop">
      <NuxtLink to="/aboutme" class="box curmudgeon p-4 w-36 h-16 relative  text-xl text-center text-white align-middle cursor-pointer">
        About Me</NuxtLink>
    </li>


    <li class="flex" @click.prevent="toTop">
      <NuxtLink to="/portfolio" class="box curmudgeon p-4 w-36 h-16 relative  text-xl text-center text-white align-middle cursor-pointer">
        Portfolio</NuxtLink>
    </li>
    <li class="flex" @click.prevent="toTop">
      <NuxtLink
          ...
          to="/contact"
          class="box curmudgeon p-4 w-36 h-16 relative text-xl text-center text-white align-middle cursor-pointer">
        Contact
